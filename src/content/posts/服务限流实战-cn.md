---
title: "服务限流实战"
description: "围绕评论机器人接入 LLM API 的场景，梳理用户侧限流、下游熔断和异步回写的实践设计。"
...
* 第一个是用户请求层面的，我们不能无限制地纵容用户一直调用机器人评论服务。
  ...
  * 2. 在技术层面，若已经在功能层面进行限制了，但是用户基数非常大，实际上仍旧有很大规模的用户在调用这个服务，我们可以使用 MQ 或者令牌桶来进行限流。
* 第二个是 LLM 服务端的流量限制。
...
* Resilience4j 和 [alibaba/Sentinel](https://github.com/alibaba/sentinel) 都有以上的功能，最终选取了 Sentinel。
* 原因
